...
{{RFC8366}} originally defined just the voucher artifact, leaving the voucher request artifact that is important to BRSKI to be defined in {{BRSKI}}.
...
of an assertion such as a PKIX certificate {{RFC5280}}, web token, or a "voucher".  With
